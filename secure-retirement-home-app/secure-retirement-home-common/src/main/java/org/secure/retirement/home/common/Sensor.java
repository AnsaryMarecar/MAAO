...
public class Sensor {
	...
	public Sensor(int sensor_id, Type_sensor type_sensor, String sensor_mac, String sensor_ip, double sensor_min, double sensor_max) {
		super();
		this.sensor_id = sensor_id;
		this.type_sensor = type_sensor;
		this.sensor_min = sensor_min;
		this.sensor_max = sensor_max;
		this.setSensor_mac(sensor_mac);
		this.setSensor_ip(sensor_ip);
	}
